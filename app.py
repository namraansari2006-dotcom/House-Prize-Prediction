...
for i in final_X:
  ...
  result = st.sidebar.slider(f'Select {i} value',min_vlaue,max_value)
...
st.succes(f'Estimated House Price is:${final_price}')
st.markdown('''**Design and Developed by:Namra Noor**''')
